  ...
  return (
    ...
    >
      ...
      <g clip-path="url(#clip5661_2108)">
        ...
        <path
          id="Vector"
          d="M12.34 7.45C12.09 7.22 11.78 7.07 11.46 7.02C11.13 6.96 10.79 7.01 10.49 7.15C10.19 7.26 9.94 7.47 9.76 7.73C9.58 8 9.49 8.31 9.48 8.63L9.48 15.37C9.49 15.68 9.58 15.99 9.76 16.26C9.94 16.52 10.19 16.73 10.49 16.85C10.7 16.94 10.94 16.99 11.18 17C11.6 16.99 12.02 16.83 12.34 16.54L16 13.18C16.16 13.03 16.29 12.84 16.38 12.64C16.47 12.44 16.51 12.22 16.51 12C16.51 11.77 16.47 11.55 16.38 11.35C16.29 11.15 16.16 10.96 16 10.82L12.34 7.45ZM11.5 14.6L11.5 9.4L14.31 12L11.5 14.6Z"
          fill="white"
          fill-opacity="1.000000"
          fill-rule="nonzero"
        />
